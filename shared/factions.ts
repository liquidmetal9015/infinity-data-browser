...
import type { FactionInfo, SuperFaction, DatabaseMetadata } from './types.js';
...
export class FactionRegistry {
    ...
    constructor(
        rawFactions: DatabaseMetadata['factions'],
    ...
    // Get all registered factions (for MCP compatibility)
