 ...
 * If value < 128, stored as single byte.
 * If value >= 128, stored as two bytes with high bit set on first byte.
 */
...
function writeVLI(value: number): number[] {
    ...
    // Set high bit on first byte, split value across two bytes
