import type { Unit, Profile, Option } from './index';

/**
 * Represents a single unit added to an army list.
 * References the base Unit plus the specific profile/option chosen.
 */
export interface ListUnit {
    /** Unique ID for this list entry (for React keys and removal) */
    id: string;
 ...
 * Standard limit is 10 units per group.
 */
